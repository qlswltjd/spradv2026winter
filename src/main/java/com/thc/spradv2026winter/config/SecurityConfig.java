...
import com.thc.spradv2026winter.security.JwtAuthenticationFilter;
import com.thc.spradv2026winter.security.JwtAuthorizationFilter;
    ...
    public class CustomDsl extends AbstractHttpConfigurer<CustomDsl, HttpSecurity> {
        ...
        public void configure(HttpSecurity http) throws Exception {
            ...
            http.addFilter(corsFilterConfiguration.corsFilter())
                    ...
                    .addFilterBefore(new com.thc.sprbasic2025fall.security.FilterExceptionHandlerFilter(), BasicAuthenticationFilter.class);
        }
